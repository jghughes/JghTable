...
const FALLBACK_DATA: unknown[] = [{ row: 1, full_name: "Joe Soap" }];
...
const BASE_COLUMN_DEFS: ColumnDef[] = [
  ...
  {
    headerName: "zFTP (W/kg)",
    field: "zwift_zftp_wkg",
    type: "numericColumn",
    width: 80,
    valueFormatter: (params) => params.value?.toFixed(2),
  },
  {
    headerName: "60min (W/kg)",
    field: "wkg_60min_curvefit",
    type: "numericColumn",
    width: 80,
    valueFormatter: (params) => params.value?.toFixed(2),
  },
  ...
  {
    headerName: "km (lead_in)",
    field: "route_lead_in_km",
    type: "numericColumn",
    width: 90,
    valueFormatter: (params) => params.value?.toFixed(1),
  },
  {
    headerName: "km (length)",
